...
# 36 "./tlv493.h" 2
# 83 "./tlv493.h"
void TLV493_Init(void);
void TLV493_Read(void);
float TLV493_X_GetValue(void);
float TLV493_Y_GetValue(void);
float TLV493_Z_GetValue(void);
float TLV493_Temp_GetValue(void);
# 7 "tlv493.c" 2




uint8_t writeBuffer[10] = {0x00, 0x00, 0x00};
uint8_t readBuffer[10] = {0x00, 0x00};

void TLV493_Init(void){
    _delay((unsigned long)((100)*(8000000/4000.0)));

    I2C_ReadNBytes(0x5E, &readBuffer, 10);
    ...
    I2C_WriteNBytes(0x5E, &writeBuffer, 10);
    _delay((unsigned long)((100)*(8000000/4000.0)));
}

void TLV493_Read(void){

    I2C_ReadNBytes(0x5E, &readBuffer, 7);
}
