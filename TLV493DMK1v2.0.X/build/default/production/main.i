...
void main(void){
    ...
    while (1){
        XDataAnz = TLV493_X_GetValue();
        YDataAnz = TLV493_Y_GetValue();
        ZDataAnz = TLV493_Z_GetValue();
        TempDataAnz = TLV493_Temp_GetValue();
        printf("X = %0.4fmT   ", XDataAnz);
        printf("Y = %0.4fmT   ", YDataAnz);
        printf("Z = %0.4fmT   ",ZDataAnz);
        printf("Temp = %0.2fC\r\n",TempDataAnz);
        _delay((unsigned long)((500)*(8000000/4000.0)));
    }
}
